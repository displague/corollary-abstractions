...
**1. The matcher discovers that sciences repeat one another.** From 229
hand-authored statement nodes across 23 disciplines, structure alone:
...
data/<discipline>/      statement corpora (23 disciplines, 229 nodes)
scripts/
...
```
python scripts/validate_nodes.py            # 229 nodes / 23 corpora green
