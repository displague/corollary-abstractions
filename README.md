...
**1. The matcher discovers that sciences repeat one another.** From 241
...
data/<discipline>/      statement corpora (24 disciplines, 241 nodes)
scripts/
...
```
python scripts/validate_nodes.py            # 241 nodes / 24 corpora green
