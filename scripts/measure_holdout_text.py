...
holdout. `experiments/text_resolution_holdout.json` was authored in one
...
QUERIES = REPO / "experiments" / "text_resolution_holdout.json"
DEFAULT_OUT = REPO / "experiments" / "text_resolution_holdout_result.json"
